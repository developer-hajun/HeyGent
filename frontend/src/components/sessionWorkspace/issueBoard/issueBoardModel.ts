...
export const ISSUE_BOARD_PRIORITIES = ['critical', 'high', 'medium', 'low'] as const
...
export type IssueBoardPriority = (typeof ISSUE_BOARD_PRIORITIES)[number]
...
export function issueBoardPriorityLabel(priority: IssueBoardPriority) {
