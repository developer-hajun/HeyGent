...
metadata:
  runtime:
    ...
    related_skills: [web-search-fallback, mcporter]
---
...
7. Prefer built-in tools unless the user wants Parallel specifically or needs Parallel-only workflows.
...
- Do not silently choose Parallel when built-in tools are already sufficient.
