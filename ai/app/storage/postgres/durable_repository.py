...
from app.storage.postgres.step_repository import StepRunRepositoryMixin
...
class PostgresTaskRepository(StepRunRepositoryMixin, PostgresDurableRepository):
    ...
    # create_step, update_step, get_step, list_steps는 StepRunRepositoryMixin에서 제공됩니다.
    ...
    # _save_step_anchor는 StepRunRepositoryMixin에서 제공됩니다.
