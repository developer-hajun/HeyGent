...
from app.tools.web_runtime.tool_backend_helpers import managed_nous_tools_enabled
...
def auth_json_path():
    """Return the local auth store path for managed tool providers."""
    return get_tool_home() / "auth.json"
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from app.tools.web_runtime.support.auth import resolve_nous_access_token
